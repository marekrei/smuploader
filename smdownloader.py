...
def download_album(album_name, path, resume = False, verbose = False):
	...
	for image_info in images_info:
		...
		sys.stdout.write('Downloading ' + album_name.encode('utf-8') + '/' + image_name + ' [' + str(count) + '/' + str(total) + ']... ')
		sys.stdout.flush()
		if verbose == True:
			print ''
...
if __name__ == '__main__':
	...
	parser.add_argument('path', metavar='PATH', type=str, help='path where the albums are downloaded')
